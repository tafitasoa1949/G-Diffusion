        ...
        $(function() {
                ...
                if ($('#chartjs_line').length) {
                    ...
                    var myChart = new Chart(ctx, {
                            ...
                            data: {
                                labels: ['Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet','Aout','Septembre','Octobre','Novembrer','Decembre'],
                                datasets: [{
                                    label: 'Societe',
                                    data: [12, 19, 3, 17, 6, 3, 7,23,20,22,15,0],
                                    ...
                                    data: [2, 29, 5, 5, 2, 3, 10,9,7,13,17,0],
