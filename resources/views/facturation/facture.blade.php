                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('/facturation') }}">
                                            <input type="hidden" name="iddiffusion" value="{{ $diffusion->id }}">
                                            <input type="hidden" name="idsociete" value="{{ $societe->id }}">
                                            <div class="form-group">
                                                <p style="color: black; ">Doit : {{ $societe->doit }}</p>
                                                <p style="color: black; ">NIF : {{ $societe->nif }}</p>
                                                <p style="color: black; ">STAT : {{ $societe->stat }}</p>
                                                <p style="color: black; ">Adresse : {{ $societe->adresse }}</p>
                                                <p style="color: black; ">Email : {{ $societe->email }}</p>
                                                <p style="color: black; ">Contact : {{ $societe->contact }}</p>
                                                <p style="color: black; ">Responsable : {{ $societe->responsable }}</p>
                                            </div>
